...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['a pareces noob o pro solo fallaste mucho', 0.2], //From 0% to 19%
		['un poco pro o solo fallaste mucho', 0.4], //From 20% to 39%
		['casi medio pro', 0.5], //From 40% to 49%
		['Bruh que pantuflas', 0.6], //From 50% to 59%
		['Mehfjyjfkgkjfkjfjjkf', 0.69], //From 60% to 68%
		['Nice', 0.7], //69%
		['bien', 0.8], //From 70% to 79%
		['Great', 0.9], //From 80% to 89%
		['coooooooooooooooool!', 1], //From 90% to 99%
